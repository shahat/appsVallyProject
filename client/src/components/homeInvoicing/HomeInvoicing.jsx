...
import animationData from "../../../public/animation/first animation.json";
...
export default function HomeInvoicing() {
  ...
  return (
    <>
      <div className="homeInvoicing container d-flex  justify-content-sm-center justify-content-md-between flex-wrap align-items-center text-white my-5 py-5 ">
        <section className="invoicingContent w-sm-100 col-sm-12 col-md-6">
          <h3 className="invoicingTitle fs-1 fw-bolder mb-3 p-sm-2">
          ...
          <div className="invoicingPara d-flex flex-column">
            <section
              ...
              data-aos="fade-right"
            >
              <BsRocketTakeoffFill className="text-success  fs-5 m-2 " />{" "}
              <p className="text-secondary text-secondary fs-md-5">
                {" "}
            ...
            >
              <BsRocketTakeoffFill className="text-success  fs-5 m-2 " />{" "}
              <p className="text-secondary fs-md-5">
                {" "}
      ...
      <div className="weOfferMuchMore container d-flex  justify-content-sm-center justify-content-md-between flex-wrap align-items-center text-white my-5 py-5">
        <section className="weOfferMuchMoreContent w-sm-100 col-sm-12 col-md-6">
          <h3
            className="weOfferMuchMoreTitle fs-1 fw-bolder mb-3"
            data-aos="fade-right"
          >
            We Offer much more
          </h3>
          <p
            className="weOfferMuchMorePara text-secondary fs-5"
            data-aos="fade-right"
          >
    ...
    justify-content-center    justify-content-md-end "
          data-aos="fade-left"
        >
          <div className="weOfferMuchMoreGIF d-flex  justify-content-center justify-content-md-end w-md-50 my-5">
            <Lottie
            ...
            <div className="row w-100  justify-content-between">
              {productsData.map((product, index) => (
                <div
                  ...
                  my-4 col-md-4    over-flow-hidden"
                  style={{ height: "300px" }}
                  data-aos="zoom-in-up"
                >
                  <div className=" mb-2">
      ...
      <div className="resources py-5 overflow-hidden">
        <div className="container">
          <h3 className="pb-5 text-white w-75" data-aos="fade-right">
            All the resources you need,right here
          </h3>
          <div className="row   flex-md-nowrap overflow-hidden  justify-content-center justify-content-md-between py-4">
            {resources.map((resource, index) => (
              <div
                key={index}
                id={`resource-${index}`}
                className="col-8 col-sm-6 col-md-4"
                ref={index === resourcesIndex ? resourcesRef : null}
                data-aos="fade-up"
                style={{ minWidth: "250px" }}
              >
                <div className="card  resourceCard  border rounded mx-md-4  ">
                  <img
                    className="resourceCardImg"
                    src={resource.img}
                    alt="Card image cap"
                  />
                  <div className="card-body border-top-0 border-bottom-rounded p-0">
                    <h5
                      className="card-title"
                      style={{ fontSize: "20px", marginBlock: "16px " }}
                    >
                      {resource.title}
                    </h5>
                    <p
                      className="text-secondary p-0"
                      style={{ paddingBottom: "16px ", fontSize: "14px" }}
                    >
      ...
      <div className="gitInTouch bg-white py-5">
        <div className="container-md">
          <div className="row justify-content-center justify-content-md-between ">
            <div className=" col-11 col-sm-6 col-md-6 ">
              <h3
                className="pb-2 fw-bolder fs-1"
                style={{ color: "#314259" }}
                data-aos="fade-right"
              >
              ...
              <p
                className="text-secondary fs-4 fw-medium"
                data-aos="fade-right"
              >
                {" "}
              ...
              <div
                className="gitInTouchImage w-100 w-md-75"
                data-aos="fade-right"
              >
                <img
                  src={resourcesImages[4]}
                  alt="desk image"
                  className="w-100"
                />
              </div>
            </div>
            <div className="col-11 col-sm-6 ps-md-5 d-flex justify-content-center align-items-center ">
              <div
                className="gitInTouchForm  my-5 m-sm-0 d-flex justify-content-center "
                id="BookADemo"
              >
                <div className=" p-md-4 p-lg-5 p-3" data-aos="fade-left">
                  <DemoForm />
                </div>
              </div>
            </div>
